...
# the change here is to generate a import-able bom.xml for dependency-track
# So I change license name to license id.
...
def build_component_element(publisher, name, version, description, hashes, license, purl, modified, copyright):
